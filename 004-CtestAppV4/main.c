...
int main()
{
    //The description is wrong. Because there is a Data tag in C.
    //Syntax error
    Data myData;

    // We should use it as "struct Data"
    struct Data myData1;
...
//In C, Typedef must be used to define the data name.
/*
typedef struct Data{
    int x;
    int y;
}MyData; //Now the struct name is MyData

int main()
{
    // Example of using struct name in C
    MyData myData;

    //Example of using struct tag in C
    struct Data data;
