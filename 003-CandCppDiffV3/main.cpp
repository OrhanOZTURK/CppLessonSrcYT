...
int main()
{
     ...
     * Its has completely changed meaning in C++.
   ...
   // auto x = 10;
    ...
    /*
    * The new tool was added with C99
    ...
    */
    ...
    // a) Expressions that give initial values to global variables do not have to be constant.
